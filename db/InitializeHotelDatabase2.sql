...
CREATE TABLE dbo.Room_Availability (
  ...
  [Room_ID] INT NOT NULL,
  [Room_Availability_Status] INT NULL DEFAULT NULL,
  PRIMARY KEY ([Room_Date], [Room_ID]),
  CONSTRAINT FK_RoomAvailabilityID FOREIGN KEY (Room_ID) REFERENCES Rooms(Room_ID))

CREATE INDEX roomavailable ON dbo.Room_Availability(Room_Availability_Status)
GO
