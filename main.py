...
def booking():
    ...
    if form.validate_on_submit():
        ...
        cursor.execute("EXEC setup_booking 3, %d, %s, %s, %s ", (room_type, "", start_date, end_date))
...
def ViewReservation():
    ...
    cursor.execute('SELECT room_ID, start_date, end_date, booking_status from Bookings where user_id = %d', 3)
